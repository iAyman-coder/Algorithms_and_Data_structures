...
int main(void) {
    ...
    int arr6[1] = {};   // Array initialized with 1 because because you can't initialize an array with a zero.
    int correct6[1] = {};
    test_array(selection_sort(arr6, 0), correct6, 0, "Empty array");

    int arr7[1] = {42};
    int correct7[1] = {42};
    test_array(selection_sort(arr7, 1), correct7, 1, "Array with single element");

    int arr8[2] = {5, 2};
    int correct8[2] = {2, 5};
    test_array(selection_sort(arr8, 2), correct8, 2, "Array of size 2");

    int arr9[4] = {7, 7, 7, 7};
    int correct9[4] = {7, 7, 7, 7};
    test_array(selection_sort(arr9, 4), correct9, 4, "Array with identical elements");

    int arr10[5] = {-3, -1, -5, -2, -4};
    int correct10[5] = {-5, -4, -3, -2, -1};
    test_array(selection_sort(arr10, 5), correct10, 5, "Array with negative numbers");

    int arr11[5] = {0, -10, 5, -2, 3};
    int correct11[5] = {-10, -2, 0, 3, 5};
    test_array(selection_sort(arr11, 5), correct11, 5, "Array with positive and negative numbers");
