...
int main(void) {
    ...
    test_result(binary_search(arr1, 10, 78), 6, "Element from right side");
    
    int arr2[7] = {3, 14, 29, 35, 42, 58, 66};
    test_result(binary_search(arr2, 7, 14), 1, "Element from left side");
    
    int arr3[10] = {5, 18, 22, 41, 57, 63, 71, 80, 89, 94};
    test_result(binary_search(arr3, 10, 57), 4, "Best case: Even sized array");
    
    int arr4[5] = {6, 19, 22, 25, 33};
    test_result(binary_search(arr4, 5, 22), 2, "Best case: Odd sized array");
    ...
    test_result(binary_search(arr14, 5, -2), 1, "Array with negative numbers and zeros");
