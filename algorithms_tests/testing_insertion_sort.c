...
int main(void) {
    ...
    int arr8[2] = {5, 2};
    int correct8[2] = {2, 5};
    test_array(insertion_sort(arr8, 2), correct8, 2, "Array of size 2");

    int arr9[4] = {7, 7, 7, 7};
    int correct9[4] = {7, 7, 7, 7};
    test_array(insertion_sort(arr9, 4), correct9, 4, "Array with identical elements");
